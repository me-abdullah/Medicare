...
<body>
    ...
    <!-- Doctors Administration Section -->
    <div class="container-fluid bg-light-gray my-4">
        <div class="container">
            <h2 class="text-center mb-4" style="font-weight: bold; color: #551123;">Our Best Cardiologist Doctors</h2>

            <div class="row my-4">
                <!-- Doctor Card Template -->
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author3.jpg" alt="Dr. Alice Carter" class="card-img-top"
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author3.jpg" alt="Dr. Robert Johnson" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author3.jpg" alt="Dr. Emily Adams" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author3.jpg" alt="Dr. Michael Brown" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author2.jpg" alt="Dr. Sarah Wilson" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author1.jpg" alt="Dr. David Lee" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author1.jpg" alt="Dr. Laura Green" class="card-img-top"
                            style="object-fit: cover; ">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author2.jpg" alt="Dr. James White" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author3.jpg" alt="Dr. Anna Black" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author3.jpg" alt="Dr. Mark Thompson" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author2.jpg" alt="Dr. Lisa Martin" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="team-member card shadow-sm rounded overflow-hidden">
                        <img src="img/author1.jpg" alt="Dr. Thomas Harris" class="card-img-top"
                            style="object-fit: cover;">
                        <div class="card-body text-center">
