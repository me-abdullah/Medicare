							...
							<table class="table table-border table-striped custom-table datatable mb-0">
                                ...
                                <tbody>
                                    @foreach($appointments as $appointment)
                                            ...
                                            <td class="text-right">
                                                {{-- <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_appointment_{{ $appointment->id }}"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div> --}}
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Delete Modal -->
                                        {{-- <div class="modal fade" id="delete_appointment_{{ $appointment->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
