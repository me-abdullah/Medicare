                                ...
                                @if (Route::has('login'))
                                    <div class="d-flex justify-content-end">
                                        @auth
                                            ...
                                            @if ($userRole === 'doctor')
                                                <a href="{{ route('doctor.dashboard') }}" class="btn ml-2">Doctor
                                                    Dashboard</a>
                                            @elseif ($userRole === 'patient')
                                                <a href="{{ route('patient.dashboard') }}" class="btn ml-2">Patient
                                                    Dashboard</a>
                                            @elseif ($userRole === 'management')
                                                <a href="{{ route('management.dashboard') }}" class="btn ml-2">Management
                                                    Dashboard</a>
                                            {{-- @else
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <form class="form" action="{{ route('appointments.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <select name="department" class="form-control wide" required>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <select name="doctor" class="form-control wide" required>
